        ...
        <div id="middleWrapper">
            ...
            <section>
                ...
                <div id="modifyContainer">
                    ...
                    <div id="modifyPanel">
                        <form action="/Modify.kh" method="post" onsubmit="return maincheck()" name="modify">
                            <div>
                                <div class="inputLable">아이디</div>
                                <div class="inputWrap">
                                    <input type="text" name="memberId" value="<%=mAll.getM().getMemberId() %>" disabled>
                                </div>
                            </div>
                            <div>
                                <div class="inputLable">비밀번호</div>
                                <div class="inputWrap">
                                    <input type="password" id="password1" name="memberPw" maxlength="20" placeholder="비밀번호를 입력해주세요">
                            ...
                            <div>
                                ...
                                <div class="inputWrap">
                                    <input type="password" id="password2" name="memberPwCheck" maxlength="20" placeholder="비밀번호를 다시 한번 입력해 주세요.">
                               ...
                               $(function(){
                            	   $('#submitBtn').click(function(){
                    				...
                    				var $memberNickname = $('input[name=memberNickname]');
                    				 ...
                    				 if(!/^[a-zA-Z0-9]{6,20}$/.test($memberPw.val())){
                    					alert("비밀번호는 영문/숫자포함 6~20자로 입력해주세요!");
                    					return false;
                    				}else if(!/^[가-힣]{2,5}$/.test($memberName.val())){
                            ...
                            <div>
                                ...
                                <div class="inputWrap">
                                    <input type="text" name="memberName" value="<%=mAll.getM().getMemberName()%>">
                                </div>
                            </div>
                            <div>
                                <div class="inputLable">닉네임</div>
                                <div class="inputWrap">
                                    <input type="text" name="memberNickname" maxlength="6" value="<%=mAll.getM().getMemberNickname() %>" disabled/>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="inputWrap">
                                    <input type="email" name="memberEmail" value="<%=mAll.getM().getMemberEmail()%>">
                                </div>
                            </div>
                            <div>
                                <div class="inputLable">휴대폰번호</div>
                                <div class="inputWrap">
                                    <input type="text" name="phone1" maxlength="3" value="<%=mAll.getM().getMemberPhone().substring(0,3) %>" id="phoneInput">
                                    <input type="text" name="phone2" maxlength="4" value="<%=mAll.getM().getMemberPhone().substring(3,7) %>" id="phoneInput">
                                    <input type="text" name="phone3" maxlength="4" value="<%=mAll.getM().getMemberPhone().substring(7,11) %>" id="phoneInput">
                                </div>
                            </div>
                            <div>
                                <div class="inputLable">주소</div>
                                <div class="inputWrap">
                                    <input type="text" id="addr" name="address" value="<%=mAll.getMa().getAddress() %>"/>
                                   </div>
                                <div class="inputLable">우편번호</div>
                                   <div class="inputWrap">
                                    <input type="text" id="addr" name="postNum" style="width:100px;" value="<%=mAll.getMa().getPostNum() %>"/>
                                </div>
                            </div>
                            <div>
